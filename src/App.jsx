...
/* ─── TEAM CARD ─────────────────────────────────────────────────────────────── */
function TeamCard({ team, onClick, scLive: scLiveProp, capLimite: capLimiteProp, allenatore: allenatoreReale }) {
  const scLive = scLiveProp ?? team.salaryUsed ?? 0;
  // Limite effettivo: 75M base + eventuale bonus obiettivi allenatore + SuperClub (+3M).
  ...
  const scColor = scLive > capLimite ? "#ef4444" : scLive > capLimite - 1 ? "#f97316" : scLive > capLimite - 5 ? "#f59e0b" : scLive > capLimite - 10 ? "#fbbf24" : scLive > capLimite - 15 ? "#888" : "#10b981";
  const scLibero = parseFloat((capLimite - scLive).toFixed(1));
  ...
  const hasAlert = u21 < u21Required || team.bilancio < 5 || scLive > capLimite || (fpf !== null && fpf > 50); // FPF warning from 50 (approaching limit)
...
function AltroTab({ team, isAdmin, mySquadra }) {
  ...
  const OBIETTIVI_ALLENATORI = {
    "Guardiola": {
      ...
      obiettivi: [
        ...
        "Vincere almeno ≥5 giornate con punteggio >80.",
        "Per ≥20 giornate 5 giocatori blu e/o viola devono partire titolari.",
      ],
      ds: ["Acquista ≥2 giocatori con quotazione ≥4 tramite clausola rescissoria."],
      dg: ["Concludi la trattativa (entrata/uscita/svincolati) più costosa in una sessione di mercato.", "Mantieni un salary cap sempre ≥67 mln."],
    },
    "Klopp": {
      moduli: "4-3-3 / 3-4-3",
      obiettivi: [
      ...
      dg: ["Cedi giocatori per un totale di ≥100 mln.", "Non spendere mai ≥25 mln di parte fissa in un singolo acquisto."],
    },
    "Luis Enrique": {
      moduli: "3-4-1-2 / 4-3-1-2",
      obiettivi: [
        "Ottieni ≥20 bonus dalle C/T.",
      ...
      dg: ["Acquista ≥2 giocatori Under-21 per un valore di ≥25 mln totali.", "Ogni ultimo del mese, non puoi avere >2 giocatori con stipendio ≥5 mln."],
    },
    "Conte": {
      ...
      dg: ["Acquista giocatori per una spesa totale ≥100 mln.", "Spendi max 9 mln per un singolo investimento."],
    },
    "Capello": {
      moduli: "4-3-1-2 / 4-4-2",
      obiettivi: [
        "Mantieni ≥5 giornate con un modificatore di difesa di ≥2 punti.",
        "In ≥4 giornate le 2 Pc devono segnare entrambe.",
        "Completa ≥22 giornate con un massimo di 1 gol subito.",
      ],
      ds: ["Devono prendere voto ≥8 giocatori verdi diversi 2 volte."],
      dg: ["Aumenta il valore totale della tua rosa di ≥20 mln a fine anno (dal 15/09 al 01/06 dopo l'aggiornamento delle quotazioni).", "Non essere mai multato e non subire mai penalità."],
    },
    "Mourinho": {
      moduli: "4-2-3-1 / 4-4-1-1",
      obiettivi: [
        "≥1 giocatore verde e ≥1 giocatore rosso vanno a bonus nella stessa giornata ≥5 volte.",
        "Ottieni ≥4 vittorie consecutive.",
        "Mantieni un blocco difensivo stabile di 3 giocatori verdi per ≥15 giornate.",
      ],
      ds: ["Devi far fare ≥40 presenze ai tuoi over 33 in rosa."],
      dg: ["A fine anno arriva almeno in finale di coppa e/o sul podio.", "Mantieni il fair play finanziario sotto 25 mln ai check di ottobre e febbraio."],
    },
    "Allegri": {
      ...
      dg: ["Acquista ≥2 giocatori per un valore (fisso + bonus) di ≥30 mln l'uno.", "Ottieni ≥40 mln dai guadagni di giornata."],
    },
    "Lippi": {
      moduli: "4-4-1-1 / 4-1-4-1",
      obiettivi: [
        "Ottieni ≥18 clean sheet schierati.",
        "Le tue W/A schierate fanno ≥24 bonus.",
        "Completa ≥12 giornate con 11 voti pieni, non subentrati.",
      ],
      ds: ["Devi far fare ≥60 presenze ai tuoi Under-21 in rosa."],
      dg: ["Rimani con ≥15 mln di liquidità a fine mercato invernale.", "I tuoi investimenti devono aver fruttato il 150% della spesa sostenuta inizialmente."],
    },
    "Sir Ferguson": {
      moduli: "4-4-2 / 3-5-2",
      obiettivi: [
      ...
      ds: ["Devi promuovere in prima squadra ≥1 giocatore del vivaio e devi cedere ad altri presidenti o svincolare ≥1 giocatore del vivaio."],
    ...
    "Ancelotti": {
      ...
      ds: ["Mantieni in Rosa ≥2 italiani in ognuno dei reparti Verdi/Blu/Viola e ≥1 nei Gialli/Rossi; devono realizzare un totale di ≥100 presenze."],
      dg: ["Chiudi la stagione con saldo positivo ≥20 mln prima della consegna dei premi di fine stagione.", "Ogni ultimo del mese, il valore di ogni colore deve essere ≤30% del totale della Rosa."],
    },
    "Sacchi": {
      moduli: "4-1-4-1 / 4-2-3-1",
      obiettivi: [
        "I tuoi giocatori verdi devono prendere un voto di 7+ ≥13 volte.",
        "Le tue T/Ds/Dd schierate fanno ≥25 bonus.",
        "Nei tuoi incontri deve realizzarsi l'over 3,5 in ≥13 match.",
      ],
      ds: ["Acquista ≥3 giocatori stranieri con quotazione ≤8, devono fare ≥25 presenze totali."],
      dg: ["Compra ≥3 giocatori e rivendili a una cifra più alta di quella dell'acquisto.", "Mantieni sempre ≥7 mln di liquidità."],
    },
  };
  ...
  const loadAll = useCallback(async () => {
    ...
    if (all) {
      const [obs, prog, moduli] = await Promise.all([
        getObiettiviCarta(all.nome, STAGIONE_CORRENTE),
        getProgressoObiettivi(team.name, STAGIONE_CORRENTE),
        getModuloTracker(team.name, STAGIONE_CORRENTE),
      ]);
      setObiettivi(obs); setProgresso(prog); setModuliTracker(moduli);
    }
    setLoadingAll(false);
  }, [team.name]);
  useEffect(() => { loadAll(); }, [loadAll]);
...
Gli obiettivi verranno azzerati.`;
  ...
  async function handleToggleC(ob,pg) {
    if (!canManageObiettivi) return;
    const finale = ['ds','dg'].includes(String(ob.tipo || '').toLowerCase());
    const msg = !pg?.completato
      ? finale
        ? `Segnare l'obiettivo come completato?\n\nIl premio sarà incassabile dal 31/05.`
        : `Segnare l'obiettivo come completato e incassare subito il premio?`
      : `Rimuovere lo stato completato da questo obiettivo?`;
    if (!window.confirm(msg)) return;
    setSavingAll(true);
    try{await upsertProgresso(team.name,ob.id,{completato:!pg?.completato,fallito:false},STAGIONE_CORRENTE);await loadAll();}catch(e){alert(e.message);}finally{setSavingAll(false);}
  }
  ...
  async function handleIncassaObiettivo(ob) {
    if (!canManageObiettivi) return;
    setSavingAll(true);
    try { await incassaObiettivo(team.name, ob.id, STAGIONE_CORRENTE); await loadAll(); }
    catch(e){ alert(e.message); }
    finally { setSavingAll(false); }
  }
  async function handleIncassaFinali() {
    if (!canManageObiettivi) return;
    if (!window.confirm('Incassare tutti gli obiettivi DS/DG completati e non ancora incassati?')) return;
    setSavingAll(true);
    try { const r = await incassaObiettiviFinali(team.name, STAGIONE_CORRENTE); alert(`Incassati ${r.totale || 0}M`); await loadAll(); }
    catch(e){ alert(e.message); }
    finally { setSavingAll(false); }
  }
  ...
  const guadReal = obiettivi.reduce((s,o)=>{const p=progresso.find(pr=>pr.obiettivo_id===o.id);return s+(p?.incassato?(o.guadagno||0):p?.malus_applicato?-(o.penalita||0):0);},0);
  const moduliStats = conteggioModuliAllenatore(moduliTracker, allenatore);
...
Per rimborsare clicca Annulla e usa "Rimborsa" dal bilancio`
  ...
  const totInvInv = investimenti.filter(i=>i.categoria==='invernale').reduce((s,i)=>s+Number(i.costo),0);
  ...
  return (
    <div style={{ display:"flex",flexDirection:"column",gap:20 }}>
        ...
        :allenatore?(
          <>
            ...
            <div style={{ display:"flex",justifyContent:"flex-end",marginBottom:8 }}>
              {canManageObiettivi && <button onClick={handleIncassaFinali} disabled={savingAll}
                style={{ padding:"7px 10px",borderRadius:8,border:"1px solid #f59e0b35",background:"#f59e0b12",color:"#f59e0b",fontSize:11,fontWeight:800,cursor:"pointer" }}>
                💰 Incassa DS/DG disponibili
              </button>}
            </div>
      ...
      <div>
        ...
        <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:12 }}>
          {[{label:"USATO",value:`${totInv.toFixed(1)}M`,sub:"/ 30M",color:totInv>30?"#ef4444":"#f59e0b"},{label:"INVERNALE",value:`${totInvInv.toFixed(1)}M`,sub:"/ 10M",color:totInvInv>10?"#ef4444":"#06b6d4"},{label:"GUADAGNI",value:`+${totGuad.toFixed(1)}M`,sub:"",color:"#10b981"}].map(s=>(
            <div key={s.label} style={{ background:"#ffffff08",borderRadius:10,padding:"10px 12px",textAlign:"center" }}>
...
function PresidentePage({ team, onBack, isAdmin, mySquadra }) {
  ...
  // Limite base 75M + eventuali bonus da obiettivi allenatore completati (art. 9.4)
  ...
  const loadRosaStipendi = useCallback(async ({ force = false } = {}) => {
    ...
    // Ricalcolate qui (invece di leggere dallo state) per evitare una race con
    // gli altri fetch in parallelo nell'useEffect di mount qui sotto: il
    // controllo SC-negativo deve usare stipendio allenatore + bonus
    // investimenti aggiornati, non valori di stato potenzialmente non ancora
    // popolati al primo giro.
    const [data, scAll, effetti] = await Promise.all([
    ...
    if (data) {
      ...
      const scRosa = rosaAttiva.reduce((s, p) => s + calcolaStipCorretto(p.quot, p.anni_contratto, p.anni), 0);
      const scTotale = parseFloat((scRosa + Number(scAll || 0)).toFixed(2));
      const limite = 75 + Number(team.scBonusObiettivi || 0) + Number(effetti?.scBonusInvestimenti || 0);
      if (!scEsenteGiuLug) await aggiornaSCNegativo(team.name, scTotale, oggi, limite);
    }
  }, [team.name]);
          ...
          <div style={{ background: "#ffffff06", border: "1.5px solid #ffffff12", borderRadius: 16, padding: 18 }}>
            ...
            {tab === "finanze" && (
              <FinanzeTab
                ...
                salaryCapLimite={salaryCapLimite}
...
/* ─── TRACKER RIVALITÀ (art. 8.3) ───────────────────────────────────────────── */
// Le sfide vs rivale non hanno un campo dedicato: sono ricavate dai movimenti
// "Guadagno giornata N (vs rivale)" salvati dal Calcolatore Giornata. Non è
// possibile ricostruire da lì vittoria/pareggio/sconfitta (l'importo è un
...
function CompareRosePage({ teams }) {
  ...
  async function caricaDati(nome, team) {
    ...
    return {
      ...
      fpf: Number(team.fpf ?? 0),
      scUsato, scLimite,
      rosaTotale: rosaAttiva.length,
      under21: rosaAttiva.filter(p => Number(p.anni || 0) > 0 && Number(p.anni || 0) <= 21).length,
  ...
  useEffect(() => {
    ...
    setLoading(true);
    Promise.all([
      caricaDati(nomeA, teams?.find(t => t.name === nomeA)),
      caricaDati(nomeB, teams?.find(t => t.name === nomeB)),
    ]).then(([a, b]) => { if (!cancelled) { setDatiA(a); setDatiB(b); setLoading(false); } });
    return () => { cancelled = true; };
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [nomeA, nomeB, teams]);
  ...
  return (
    <div>
      <h1 style={{ fontSize: 20, fontWeight: 900, color: "#f0f0f0", fontFamily: "'Bebas Neue',sans-serif", letterSpacing: "1px", marginBottom: 4 }}>⚖️ COMPARA ROSE</h1>
      <p style={{ fontSize: 12, color: "#888", marginBottom: 14 }}>Confronto rapido tra due squadre — utile prima di aprire una trattativa.</p>

      <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap", marginBottom: 16 }}>
        <select value={nomeA} onChange={e => setNomeA(e.target.value)} style={sel}>
          {teams?.map(t => <option key={t.name} value={t.name}>{t.name}</option>)}
        </select>
        <span style={{ color: "#555", fontSize: 12, fontWeight: 700 }}>VS</span>
        <select value={nomeB} onChange={e => setNomeB(e.target.value)} style={sel}>
          {teams?.map(t => <option key={t.name} value={t.name}>{t.name}</option>)}
        </select>
      </div>
            ...
            <table style={{ width: "100%", minWidth: 480, borderCollapse: "collapse", fontSize: 13 }}>
              <thead>
                <tr style={{ borderBottom: "1px solid #ffffff15" }}>
                  ...
                  <th style={{ padding: "8px 6px", textAlign: "center", color: "#6366f1", fontWeight: 800 }}>{nomeA}</th>
                  <th style={{ padding: "8px 6px", textAlign: "center", color: "#f59e0b", fontWeight: 800 }}>{nomeB}</th>
                </tr>
              </thead>
              <tbody>
                {righeMetriche.map(r => {
...
/* ─── COMPARATORE GIOCATORI ─────────────────────────────────────────────────── */
function ComparePlayersPage({ teams }) {
  ...
  const risultatiRicerca = useMemo(() => {
    ...
    return listone.filter(p => (p.nome || "").toLowerCase().includes(q) && !selezionati.some(s => s.id === p.id)).slice(0, 12);
  }, [listone, search, selezionati]);
  ...
  function aggiungi(p) {
    if (selezionati.length >= 5) return;
    setSelezionati(s => [...s, p]);
    setSearch("");
  }
  ...
  return (
    <div>
      <h1 style={{ fontSize: 20, fontWeight: 900, color: "#f0f0f0", fontFamily: "'Bebas Neue',sans-serif", letterSpacing: "1px", marginBottom: 4 }}>🆚 COMPARA GIOCATORI</h1>
      <p style={{ fontSize: 12, color: "#888", marginBottom: 14 }}>Scegli fino a 5 giocatori dal listone (in rosa o svincolati) e confronta tutti i loro dati.</p>

      <div style={{ position: "relative", marginBottom: 16 }}>
        <input type="text" placeholder="🔍 Cerca un giocatore da aggiungere..." value={search} onChange={e => setSearch(e.target.value)}
          disabled={selezionati.length >= 5} style={inp} />
        {selezionati.length >= 5 && <span style={{ marginLeft: 10, fontSize: 11, color: "#666" }}>Massimo 5 giocatori — rimuovine uno per aggiungerne un altro.</span>}
        {risultatiRicerca.length > 0 && (
          <div style={{ position: "absolute", top: "100%", left: 0, marginTop: 4, background: "#14161c", border: "1px solid #ffffff18", borderRadius: 8, width: 320, maxHeight: 280, overflowY: "auto", zIndex: 20, boxShadow: "0 8px 24px #00000060" }}>
            {risultatiRicerca.map(p => (
              <div key={p.id} onClick={() => aggiungi(p)}
                style={{ padding: "8px 12px", cursor: "pointer", fontSize: 12, borderBottom: "1px solid #ffffff08", display: "flex", justifyContent: "space-between" }}
                onMouseEnter={e => e.currentTarget.style.background = "#ffffff08"} onMouseLeave={e => e.currentTarget.style.background = "transparent"}>
                <span style={{ color: "#ddd" }}>{p.ruolo} · {p.nome}</span>
                <span style={{ color: "#666" }}>{trovaSquadra(p)?.name || "Svincolato"}</span>
              </div>
            ))}
          </div>
        )}
      ...
      {selezionati.length === 0 ? (
        <div style={{ fontSize: 12, color: "#555", fontStyle: "italic", background: "#ffffff06", border: "1px solid #ffffff10", borderRadius: 10, padding: 14 }}>
          Nessun giocatore selezionato. Usa la ricerca sopra per aggiungerne.
        </div>
      ) : (
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", minWidth: 200 + selezionati.length * 140, borderCollapse: "collapse", fontSize: 12 }}>
            <thead>
              <tr style={{ borderBottom: "1px solid #ffffff15" }}>
                <th style={{ padding: "8px 6px", textAlign: "left", color: "#555", fontSize: 10, position: "sticky", left: 0, background: "#0d0f14" }}>DATO</th>
                {selezionati.map(p => (
...
function MercatoPage({ profile, isAdmin, teams, offerteInAttesa = [], statoMercato }) {
  ...
  const getSalaryRecap = (trattativa) => {
    ...
    const capLimite = 75 + Number(buyer?.scBonusObiettivi || 0); // SuperClub non incluso qui: solo stima, l'enforcement reale è in aggiornaSCNegativo
    return { buyer, currentSC, newStip, newSC, freeAfter: parseFloat((capLimite - newSC).toFixed(2)) };
  };
...
function ChiamataCard({ chiamateGiocatore, mySquadra, isAdmin, onInteresse, onRefresh, aste, dsMasterclass }) {
  const [saving, setSaving] = useState(false);
  const [scadOfferteAttesa, setScadOfferteAttesa] = useState(null);

  const primaria = chiamateGiocatore?.length ? (chiamateGiocatore.find(c => c.tipo === 'prima') || chiamateGiocatore[0]) : null;

  // Anteprima di quando scadrebbe la raccolta offerte, calcolata con la stessa
  // logica (freeze notturno + distacco minimo 30' / slot venerdì) usata
  // davvero al momento della creazione dell'asta — utile per sapere già ora
  // entro quando bisognerà mandare l'offerta, anche se l'asta non esiste ancora.
  useEffect(() => {
    let cancelled = false;
    setScadOfferteAttesa(null);
    if (!primaria) return;
    calcolaScadenzaOfferteAttesa(primaria).then(d => { if (!cancelled) setScadOfferteAttesa(d); }).catch(() => {});
    return () => { cancelled = true; };
  }, [primaria?.giocatore, primaria?.scadenza_interesse, primaria?.modalita]);

  if (!chiamateGiocatore?.length || !primaria) return null;
          ...
          {isAdmin && !astaAssegnata && (
            <div style={{ display: "flex", flexDirection: "column", gap: 5, alignItems: "flex-end" }}>
              {!astaAttiva && (scadutaInteresse ? (
                // Sempre "Crea Asta", anche con un solo interessato: il prezzo
                // resta comunque fissato a ¾Q (vedi rivelaECompletaAsta), ma
                // deve comunque entrare in coda per rispettare l'ordine di
                // chiamata e il distanziamento minimo tra le scadenze.
                <button onClick={handleCreaAsta} disabled={saving}
                  ...
                  {saving ? "..." : interessati.length === 1 ? `🏷️ Crea Asta (¾Q, unico interessato)` : `🏷️ Crea Asta (${interessati.length} interessati)`}
                </button>
              ) : (
...
function AdminControlRoomPage({ teams }) {
  ...
  async function loadInvestimentiAdmin() {
    setAdminTabBusy('investimenti_load');
    try {
      const { data, error } = await supabase.from('investimenti').select('*').order('squadra').order('data_acquisto', { ascending: false });
      if (error) throw error;
      setInvestimentiAdmin(data || []);
    } catch(e) { alert(`Errore investimenti: ${e.message}`); }
    finally { setAdminTabBusy(null); }
  }

  async function loadObiettiviAdmin() {
    setAdminTabBusy('obiettivi_load');
    try {
      const [allenatoriRes, progressiRes, moduliRes] = await Promise.all([
        supabase.from('allenatori_carte').select('*').order('squadra', { ascending: true }),
        supabase.from('progresso_obiettivi').select('*, obiettivi_carte(*)').eq('stagione', STAGIONE_CR),
        supabase.from('moduli_allenatore_tracker').select('*').eq('stagione', STAGIONE_CR).order('squadra').order('giornata'),
      ]);
      if (allenatoriRes.error) throw allenatoriRes.error;
      if (progressiRes.error) throw progressiRes.error;
      setObiettiviAdmin({ allenatori: allenatoriRes.data || [], progressi: progressiRes.data || [], moduli: moduliRes.data || [] });
    } catch(e) { alert(`Errore obiettivi: ${e.message}`); }
    finally { setAdminTabBusy(null); }
  }

  async function loadVivaioAdmin() {
    setAdminTabBusy('vivaio_load');
    try {
      const { data, error } = await supabase.from('rosa').select('*').eq('in_vivaio', true).order('squadra').order('nome');
      if (error) throw error;
      setVivaioAdmin(data || []);
    } catch(e) { alert(`Errore vivaio: ${e.message}`); }
    finally { setAdminTabBusy(null); }
  }

  async function loadPrestitiAdmin() {
    setAdminTabBusy('prestiti_load');
    try {
  ...
  async function loadAuditAdmin() {
    setAdminTabBusy('audit_load');
    try { setAuditAdmin(await getAuditLog({ limit: 150 })); }
    catch(e) { alert(`Errore audit: ${e.message}`); }
    finally { setAdminTabBusy(null); }
  }
  ...
  const tabs = [
    ...
    { key: 'investimenti_admin', icon: '📈', label: 'Investimenti' },
    { key: 'obiettivi_admin', icon: '🎯', label: 'Obiettivi' },
    { key: 'vivaio_admin', icon: '🌱', label: 'Vivaio' },
    { key: 'prestiti_admin', icon: '🔁', label: 'Prestiti' },
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
      ...
      {loading ? (
        ...
        <>
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, flexWrap: 'wrap', gap: 10 }}>
                <div>
                  ...
                  <div style={{ fontSize: 11, color: '#555', marginTop: 4 }}>Base: 4M · Bonus attivo da investimento stadio acquistato in stagioni precedenti: 5.5M · Pagamento il 1° di ogni mese</div>
                </div>
                <button
                ...
                {(status?.squadre || []).sort((a,b) => a.name.localeCompare(b.name)).map(sq => {
                  ...
                  return (
                    <div key={sq.name} style={{ background: '#ffffff06', border: '1px solid #ffffff10', borderRadius: 12, padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
                      ...
                      {/* Toggle upgrade */}
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <span style={{ fontSize: 10, color: '#555' }}>Bonus stadio attivo ora</span>
                        <button
          ...
          {tab === 'quote' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div style={{ fontSize: 11, fontWeight: 700, color: '#888', letterSpacing: '0.1em' }}>💶 QUOTE / EXTRA / ISCRIZIONE — STAGIONE {STAGIONE_CR}</div>
              <div style={{ background: '#10b98108', border: '1px solid #10b98120', borderRadius: 10, padding: '10px 14px', fontSize: 12, color: '#aaa', lineHeight: 1.6 }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
              ...
              {investimentiAdmin && (() => {
                ...
                for (const inv of investimentiAdmin) {
                  byTeam[inv.squadra] ||= [];
                  byTeam[inv.squadra].push(inv);
                }
                return <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(280px,1fr))', gap:10 }}>
                  {Object.entries(byTeam).sort().map(([squadra, rows]) => {
                    const stag = rows.filter(r => r.stagione === STAGIONE_CR);
                    const tot = stag.reduce((a,r)=>a+Number(r.costo||0),0);
                    const inv = stag.filter(r => r.categoria === 'invernale').reduce((a,r)=>a+Number(r.costo||0),0);
                    const effetti = rows.filter(r => ['SuperClub','Settore Giovanile Avanzato','Deroga U-21','Clausola Segreta','Ristrutturazione Stadio','DS Masterclass'].includes(r.nome));
                    return <div key={squadra} style={{ background:'#ffffff06', border:'1px solid #ffffff12', borderRadius:12, padding:'12px 14px' }}>
                      <div style={{ fontSize:13, fontWeight:900, color:'#f0f0f0' }}>{squadra}</div>
                      <div style={{ fontSize:11, color: tot>30?'#ef4444':'#888', marginTop:4 }}>Stagione: {tot.toFixed(1)}M / 30M · Invernali: {inv.toFixed(1)}M / 10M</div>
                      <div style={{ marginTop:8, display:'flex', flexDirection:'column', gap:5 }}>
                        {rows.slice(0,8).map(r => <div key={r.id} style={{ fontSize:11, color:'#aaa', borderTop:'1px solid #ffffff08', paddingTop:5 }}>
                          <b style={{ color:r.attivo === false ? '#666' : '#c7d2fe' }}>{r.nome}</b> · {r.costo}M · {r.stagione} {r.attivo === false ? '· inattivo' : ''}
                          {Array.isArray(r.dati?.tracker) && r.dati.tracker.length > 0 && <span style={{ color:'#10b981' }}> · tracker {r.dati.tracker.length}</span>}
                        </div>)}
                        {effetti.length > 0 && <div style={{ fontSize:10, color:'#f59e0b', marginTop:4 }}>Effetti regolamentari: {effetti.map(e=>e.nome).join(' · ')}</div>}
                      </div>
                    </div>;
                  })}
                </div>;
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
              ...
              {obiettiviAdmin && <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))', gap:10 }}>
                {(teams||[]).map(t => {
                  ...
                  const progressi = obiettiviAdmin.progressi.filter(p => p.squadra === t.name);
                  const moduli = obiettiviAdmin.moduli.filter(m => m.squadra === t.name);
                  const conteggio = conteggioModuliAllenatore(moduli, card);
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
              ...
              {vivaioAdmin && <div style={{ display:'flex', flexDirection:'column', gap:6 }}>
                {vivaioAdmin.length === 0 ? <div style={{ color:'#666', fontSize:12 }}>Nessun giocatore in vivaio.</div> : vivaioAdmin.map(p => {
                  ...
                  const alertV = p.vivaio_decisione_richiesta || Number(p.vivaio_presenze || p.presenze_voto || 0) >= 2 || aumento >= 2;
                  return <div key={p.id} style={{ background: alertV ? '#f59e0b10' : '#ffffff06', border:`1px solid ${alertV ? '#f59e0b35' : '#ffffff12'}`, borderRadius:10, padding:'9px 12px', display:'flex', justifyContent:'space-between', gap:10, flexWrap:'wrap' }}>
                    <div><b style={{ color:'#f0f0f0' }}>{p.nome}</b> <span style={{ color:'#666' }}>· {p.squadra}</span><div style={{ fontSize:11, color:'#888' }}>Q {p.quot} · Q iniziale {p.quot_iniziale_vivaio ?? '—'} · presenze {p.vivaio_presenze ?? p.presenze_voto ?? 0}</div></div>
                    <div style={{ fontSize:11, color: alertV ? '#f59e0b' : '#10b981', fontWeight:700 }}>{p.vivaio_decisione_richiesta ? `Decisione entro ${p.vivaio_decisione_scadenza || '—'}` : 'OK'}</div>
                  </div>;
                })}
              </div>}
            </div>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
              ...
              {prestitiAdmin && <div style={{ display:'flex', flexDirection:'column', gap:6 }}>
                {prestitiAdmin.length === 0 ? <div style={{ color:'#666', fontSize:12 }}>Nessun prestito attivo.</div> : prestitiAdmin.map(p => <div key={p.id} style={{ background:'#ffffff06', border:'1px solid #ffffff12', borderRadius:10, padding:'9px 12px', display:'flex', justifyContent:'space-between', gap:10, flexWrap:'wrap' }}>
                  ...
                  <div style={{ fontSize:11, color:p.rescissione_prestito_attiva ? '#f59e0b' : '#10b981', fontWeight:700 }}>{p.rescissione_prestito_attiva ? `Rientro previsto ${p.rescissione_prestito_scadenza || '—'}` : 'Attivo'}</div>
                </div>)}
              </div>}
            </div>
          )}
          ...
          {tab === 'fpf' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div style={{ background: '#ef444408', border: '1px solid #ef444420', borderRadius: 10, padding: '10px 14px', fontSize: 12, color: '#aaa', lineHeight: 1.6 }}>
                Periodi regolamentari: <b style={{ color: '#f87171' }}>16/02 → 15/09</b> e <b style={{ color: '#f87171' }}>16/09 → 15/02</b>.<br/>
                Soglia: <b>50M</b> netto speso · Fasce: 50–55 = 10M, 55–60 = 15M + 2pt, &gt;60 = 20M + 4pt + 5€.<br/>
                ...
                onClick={async () => {
                  ...
                  try {
                    const results = await Promise.all((teams || []).map(t =>
                      getDettaglioSvincoliStagione(t.name).then(d => [t.name, d])
                    ));
                    const map = {};
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              {dbImportDone && (
                <div style={{ background: '#10b98110', border: '1px solid #10b98130', borderRadius: 12, padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 10 }}>
                  ...
                  {(dbImportDone.fuoriListaNomi?.length || 0) > 0 && (
                    <details style={{ fontSize: 11, color: '#f97316' }}>
                    ...
                    return (
                      <div key={sq.squadra} style={{ background: '#ffffff06', border: '1px solid #ffffff10', borderRadius: 10, padding: '9px 14px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                          ...
                          <span style={{ fontSize: 11, color: '#666' }}>{sq.pt ?? sq.pt_totali ?? '—'} pt</span>
                        </div>
              ...
              {auditAdmin && <div style={{ display:'flex', flexDirection:'column', gap:6, maxHeight:520, overflowY:'auto' }}>
                {auditAdmin.length === 0 ? <div style={{ color:'#666', fontSize:12 }}>Nessun log disponibile.</div> : auditAdmin.map(l => <div key={l.id} style={{ background:'#ffffff06', border:'1px solid #ffffff12', borderRadius:10, padding:'9px 12px' }}>
                  <div style={{ display:'flex', justifyContent:'space-between', gap:10, flexWrap:'wrap' }}>
                    <b style={{ color:'#f0f0f0', fontSize:12 }}>{l.azione}</b>
                    <span style={{ color:'#666', fontSize:10 }}>{l.timestamp ? new Date(l.timestamp).toLocaleString('it-IT') : ''}</span>
                  </div>
                  <div style={{ fontSize:11, color:'#aaa', marginTop:4 }}>{l.squadra || '—'} · {l.descrizione || ''}</div>
                  {l.rollback_possibile && !l.rollback_effettuato && <button onClick={async()=>{ if(!window.confirm('Eseguire rollback di questa azione?')) return; try { await effettuaRollback(l.id, 'admin'); await loadAuditAdmin(); } catch(e){ alert(e.message); } }} style={{ marginTop:6, padding:'4px 9px', borderRadius:7, border:'1px solid #ef444440', background:'#ef444410', color:'#ef4444', fontSize:10, fontWeight:700 }}>↩ Rollback</button>}
                </div>)}
              </div>}
            </div>
          )}
...
function StoricoPage({ isAdmin, allClubIdentities = [] }) {
  ...
  useEffect(() => {
    Promise.all([getStagioniPassate(), getRegolamentoArticoli(), getChangelog()]).then(([s, a, c]) => {
      setStagioni(s);
      setArticoli(a);
      setChangelog(c);
      setLoading(false);
  ...
  // ── Changelog edit ──
  const openEditLog = (v) => setEditLog(v ? { ...v } : { data: new Date().toISOString().slice(0,10), titolo: '', testo: '' });
  const salvaLog = async () => {
    if (!editLog?.titolo) return;
    setSavingLog(true);
    try {
      if (editLog.id) await upsertChangelogEntry(editLog);
      else await insertChangelogEntry(editLog);
      setChangelog(await getChangelog());
      setEditLog(null);
    } catch(e) { alert('Errore: ' + e.message); }
    setSavingLog(false);
  };
  const eliminaLog = async (id) => {
    if (!confirm('Eliminare questa voce di changelog?')) return;
  ...
  return (
    <div style={{ maxWidth: 860, margin: '0 auto', padding: '24px 16px' }}>
        ...
        {tab === 'changelog' && (
          <div>
            <div style={{ color:'#888', fontSize:12, marginBottom:16, lineHeight:1.5 }}>
              Cosa è cambiato nell'app di recente — aggiornato ad ogni release.
            </div>
            {isAdmin && (
              <button onClick={() => openEditLog(null)} style={{ background:'#10b981', color:'#000', border:'none', borderRadius:8, padding:'8px 16px', fontWeight:700, cursor:'pointer', fontSize:13, marginBottom:20 }}>+ Aggiungi Voce</button>
            )}

            {changelog.length === 0 && (
              <div style={{ ...card, textAlign:'center', color:'#555', padding:48 }}>
                <div style={{ fontSize:40, marginBottom:12 }}>📝</div>
                <div style={{ fontWeight:700, fontSize:15 }}>Nessuna voce di changelog</div>
                {isAdmin && <div style={{ color:'#444', fontSize:13, marginTop:6 }}>Usa il pulsante sopra per aggiungerne una</div>}
              </div>
            )}

            {changelog.map(v => (
              <div key={v.id} style={{ ...card, display:'flex', gap:14 }}>
                <div style={{ flexShrink:0, width:80, textAlign:'right' }}>
                  <div style={{ color:'#10b981', fontSize:11, fontWeight:800 }}>{new Date(v.data+'T00:00:00').toLocaleDateString('it-IT', { day:'2-digit', month:'short' })}</div>
                  <div style={{ color:'#555', fontSize:10 }}>{new Date(v.data+'T00:00:00').getFullYear()}</div>
                </div>
                <div style={{ flex:1, borderLeft:'2px solid #10b98130', paddingLeft:14 }}>
                  <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:8 }}>
                    <span style={{ color:'#fff', fontWeight:700, fontSize:14 }}>{v.titolo}</span>
                    {isAdmin && (
                      <div style={{ display:'flex', gap:6, flexShrink:0 }}>
                        <button onClick={() => openEditLog(v)} style={{ background:'#ffffff10', border:'none', borderRadius:6, color:'#aaa', padding:'3px 8px', cursor:'pointer', fontSize:11 }}>✏️</button>
                        <button onClick={() => eliminaLog(v.id)} style={{ background:'#ef444415', border:'none', borderRadius:6, color:'#ef4444', padding:'3px 8px', cursor:'pointer', fontSize:11 }}>🗑</button>
                      </div>
                    )}
                  </div>
                  {v.testo && <p style={{ color:'#ccc', fontSize:12, lineHeight:1.6, whiteSpace:'pre-wrap', margin:'6px 0 0' }}>{v.testo}</p>}
                </div>
              </div>
            ))}
          </div>
      ...
      {/* ── Changelog Modal ── */}
      {editLog && (
        <div style={{ position:'fixed', inset:0, background:'#000000cc', display:'flex', alignItems:'center', justifyContent:'center', zIndex:1000, padding:16 }} onClick={e => e.target===e.currentTarget && setEditLog(null)}>
          <div className="modal-pad" style={{ background:'#1a1d27', borderRadius:16, padding:28, width:'100%', maxWidth:560, maxHeight:'90vh', overflowY:'auto', border:'1px solid #ffffff15' }}>
            <h3 style={{ color:'#fff', marginBottom:20, fontSize:16, fontWeight:700 }}>{editLog.id ? 'Modifica Voce' : 'Nuova Voce Changelog'}</h3>
            <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
              <div style={{ display:'flex', gap:10 }}>
                <div style={{ flex:'0 0 150px' }}>
                  <label style={{ color:'#888', fontSize:12, fontWeight:700, display:'block', marginBottom:4 }}>Data</label>
                  <input type="date" value={editLog.data||''} onChange={e => setEditLog(p=>({...p, data:e.target.value}))} style={inp} />
                </div>
                <div style={{ flex:1 }}>
                  <label style={{ color:'#888', fontSize:12, fontWeight:700, display:'block', marginBottom:4 }}>Titolo</label>
                  <input value={editLog.titolo||''} onChange={e => setEditLog(p=>({...p, titolo:e.target.value}))} placeholder="es. Vincolo salary cap negativo" style={inp} />
                </div>
              </div>
              <div>
                <label style={{ color:'#888', fontSize:12, fontWeight:700, display:'block', marginBottom:4 }}>Dettaglio (opzionale)</label>
                <textarea value={editLog.testo||''} onChange={e => setEditLog(p=>({...p, testo:e.target.value}))} rows={6} placeholder="Cosa è cambiato, in breve..." style={{ ...inp, resize:'vertical', fontFamily:'inherit', lineHeight:1.6 }} />
              </div>
            </div>
            <div style={{ display:'flex', gap:10, marginTop:20, justifyContent:'flex-end' }}>
              <button onClick={() => setEditLog(null)} style={{ background:'#ffffff10', border:'none', borderRadius:8, color:'#aaa', padding:'8px 16px', cursor:'pointer', fontWeight:700 }}>Annulla</button>
              <button onClick={salvaLog} disabled={savingLog} style={{ background:'#10b981', border:'none', borderRadius:8, color:'#000', padding:'8px 20px', cursor:'pointer', fontWeight:700 }}>{savingLog ? 'Salvo…' : 'Salva'}</button>
            </div>
          </div>
        </div>
      )}
...
function NotificationBell({ mySquadra, navigate }) {
  ...
  const load = useCallback(() => {
    if (!mySquadra) return;
    getNotificheApp(mySquadra, 30).then(rows => { if (rows) setNotifiche(rows); });
  }, [mySquadra]);
  ...
  useEffect(() => {
    if (!mySquadra) return;
    const sub = subscribeNotificheApp(payload => {
      const row = payload.new;
      if (row.squadra_destinataria === mySquadra || row.squadra_destinataria === null) load();
    });
    return () => supabase.removeChannel(sub);
  }, [mySquadra, load]);
  ...
  if (!mySquadra) return null;
  const nonLette = notifiche.filter(n => !n.letta);
  const notifichePrivate = notifiche.filter(n => n.squadra_destinataria != null);
  const notifichePubbliche = notifiche.filter(n => n.squadra_destinataria == null);
  const notificheTab = tab === "private" ? notifichePrivate : notifichePubbliche;
  const nonLetteTab = notificheTab.filter(n => !n.letta);

  async function handleClick(n) {
    setOpen(false);
    if (!n.letta) {
      setNotifiche(v => v.map(x => x.id === n.id ? { ...x, letta: true } : x));
      segnaNotificaLetta(n.id, mySquadra).catch(() => {});
    }
    if (n.link_pagina) navigate(n.link_pagina);
  }

  async function handleSegnaTutte(e) {
    e.stopPropagation();
    const ids = nonLetteTab.map(n => n.id);
    if (!ids.length) return;
    setNotifiche(v => v.map(x => ids.includes(x.id) ? { ...x, letta: true } : x));
        ...
        <div style={{ position: "fixed", top: panelPos.top, right: panelPos.right, width: panelPos.width, maxHeight: 460, overflowY: "auto", background: "#12141a", border: "1px solid #ffffff14", borderRadius: 12, boxShadow: "0 8px 30px #00000060", zIndex: 300 }}>
          <div style={{ position: "sticky", top: 0, background: "#12141a", zIndex: 1 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 12px 6px", borderBottom: "1px solid #ffffff0a" }}>
              ...
              {nonLetteTab.length > 0 && <button onClick={handleSegnaTutte} style={{ background: "none", border: "none", color: "#818cf8", fontSize: 10, fontWeight: 700, cursor: "pointer" }}>Segna tutte lette</button>}
            </div>
            <div style={{ display: "flex", borderBottom: "1px solid #ffffff0a" }}>
              {[["private", "Private", notifichePrivate], ["pubbliche", "Pubbliche", notifichePubbliche]].map(([key, label, rows]) => {
                const nLetteTabBtn = rows.filter(n => !n.letta).length;
                return (
                  <button key={key} onClick={() => setTab(key)}
                    style={{ flex: 1, padding: "8px 6px", background: "none", border: "none", borderBottom: tab === key ? "2px solid #6366f1" : "2px solid transparent", color: tab === key ? "#f0f0f0" : "#666", fontSize: 11, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 5 }}>
                    {label}
                    {nLetteTabBtn > 0 && <span style={{ background: "#ef4444", color: "#fff", borderRadius: "50%", minWidth: 14, height: 14, padding: "0 3px", fontSize: 8, fontWeight: 900, display: "flex", alignItems: "center", justifyContent: "center" }}>{nLetteTabBtn > 9 ? "9+" : nLetteTabBtn}</span>}
                  </button>
                );
              })}
            </div>
